...
Function Arguments:
        ...
        glacier_model   = glaciers & small ice caps model; `:gsic` = the
...
function create_brick_doeclim(;ssprcp_scenario::String = "ssp245", start_year::Int=1850, end_year::Int=2020, glacier_model::Symbol=:gsic)
    ...
    update_param!(brick_doeclim, :antarctic_icesheet, :ais_temperature_coefficient, 0.9259)
    update_param!(brick_doeclim, :antarctic_icesheet, :ais_temperature_intercept, 17.0685)
