...
# BRICK calibration
x = MimiBRICK.run_calibration(log_posterior_brick; output_dir = output_dir, model_config="brick", calibration_start_year=calibration_start_year,
...
x = MimiBRICK.run_calibration(log_posterior_doeclimbrick; output_dir = output_dir, model_config="doeclimbrick", calibration_start_year=1850, calibration_end_year=2017,
...
x = MimiBRICK.run_calibration(model_config="sneasybrick", output_dir = output_dir, calibration_start_year=1850, calibration_end_year=2017,
